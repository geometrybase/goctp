...
/*
#cgo linux LDFLAGS: -fPIC -L${SRCDIR}/api/v6.3.16_20190305_tradeapi_linux64 -Wl,-rpath,${SRCDIR}/api/v6.3.16_20190305_tradeapi_linux64 -lthostmduserapi_se -lthosttraderapi_se -lstdc++
